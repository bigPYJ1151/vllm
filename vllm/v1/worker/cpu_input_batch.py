...
class CPUInputBatch(InputBatch):
    ...
    def __init__(
        ...
        # reset tensors
        self.block_table = self.block_table_cpu_tensor
    ...
    def _move_req(self, dst: int, src: int):
        ...
        self.block_table_cpu[dst] = self.block_table_cpu[src]
    ...
    def reorder(self) -> None:
        ...
        cached_num_computed_tokens_cpu = self.num_computed_tokens_cpu[
            reorder_prompt_req_index]
        cached_block_table_cpu = self.block_table_cpu[
            reorder_prompt_req_index].copy()
        ...
        self.block_table_cpu[reorder_prompt_req_index] = cached_block_table_cpu
