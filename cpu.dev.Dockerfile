...
ENV LD_LIBRARY_PATH="/.pyenv/versions/3.11.0/lib/python3.11/site-packages/torch/lib/:$LD_LIBRARY_PATH"

RUN git clone -b perf_data  https://github.com/bigPYJ1151/vllm.git && cd vllm && make py_install_cpu

RUN rm /.pyenv/versions/3.11.0/lib/python3.11/site-packages/torch/lib/libgomp-a34b3233.so.1 && cp llvm-project/build-omp/runtime/src/libgomp.so /.pyenv/versions/3.11.0/lib/python3.11/site-packages/torch/lib/libgomp-a34b3233.so.1
