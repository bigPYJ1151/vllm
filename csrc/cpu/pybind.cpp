...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  // SHM CCL
  ops.def("init_shm_manager", &init_shm_manager,
          "Initialize shared memory collective communication manager.");
  ops.def("join_shm_manager", &join_shm_manager,
          "Exchange shared memory collective communication managers between "
          "ranks.");
  ops.def("shm_allreduce", &shm_allreduce,
