...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, ops) {
  ...
  ops.def(
      "init_shm_manager(str ip_port, int group_size, int rank, int rank_buffer_size) -> ()", &init_shm_manager);
  ops.def(
      "join_shm_manager(str ip_port, int group_size, int rank, int rank_buffer_size) -> str", &join_shm_manager);
