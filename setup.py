...
if BUILD_CPU_OPS:
    CXX_FLAGS += [
        "-DVLLM_BUILD_CPU_OPS", "-fopenmp", "-mavx512f", "-mavx512bw", "-mavx512bf16",
        "-mavx512vl", "-mavx512dq", "-fselective-scheduling", "-fsel-sched-pipelining", "-fsel-sched-pipelining-outer-loops"
    ]
    CPU_OPS_SOURCES += [
